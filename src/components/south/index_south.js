...
// list แนะนำภาคใต้ แต่ละที่
export const item_advice_south_01Store = defineStore('item_advice_south_01', () => {
  const item_advice_south_list_01 = ref([
    {
      name: 'หมวกกันควาร้อน',
  ...
  return { item_advice_south_list_01 }
})

export const item_advice_south_02Store = defineStore('item_advice_south_02', () => {
  const item_advice_south_list_02 = ref([
    {
      name: 'หมวกกันควาร้อน',
      category: 'ของใช้และเสื้อผ้า',
      img: 'https://img.th.my-best.com/contents/f8b0e3dd690b72d9bacaf49005389044.png?ixlib=rails-4.3.1&q=70&lossless=0&w=1200&h=900&fit=crop&s=b0c37306f82db8a451cbba7c90ed9ba8'
    ...
    },
    {
      name: 'รองเท้ากันลื่น',
      category: 'ของใช้และเสื้อผ้า',
      img: 'https://image.bestreview.asia/wp-content/uploads/2023/04/best-bright-colored-shoes-8-300x300.jpg'
    }
  ])

  return { item_advice_south_list_02 }
})
